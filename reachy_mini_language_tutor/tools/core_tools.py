...
PROFILES_DIRECTORY = "reachy_mini_language_tutor.profiles"
...
class ToolDependencies:
    ...
    memory_manager: Any | None = None  # TutorMemory for persistent memory
...
def _load_profile_tools() -> None:
    ...
    for tool_name in tool_names:
        ...
        if not loaded:
            try:
                shared_tool_module = f"reachy_mini_language_tutor.tools.{tool_name}"
